      ...
      <div className="app-modal-body">
        <form className="app-modal-body-inner" onSubmit={saveStyle}>
          <div className="fields">
            <div className="field">
              ...
              <div className="field-input">
                <input type="text" ref={nameInputRef} value={name} onChange={changeStyleName} className="form-input" />
              </div>
            </div>
            <div className="field hostBrdTopContrast">
              <div className="field-label">{locale.editStyleFolderLabel}</div>
              <div className="field-input">
                <select value={folder} onChange={changeStyleFolder} className="form-input">
            ...
            <div className="field hostBrdTopContrast">
              ...
              <button type="button" className="style-edit-copy-btn btn" onClick={copyLayerStyle}>
            ...
            <div className="field hostBrdTopContrast">
              ...
              <div className="field-input">
                <textarea rows={2} value={prefixes} onChange={changePrefixes} className="form-input" />
              </div>
          ...
          <div className="fields style-edit-actions hostBrdTopContrast">
            <button type="submit" className={"style-edit-save " + (edited ? "btn btn--primary" : "btn")}>
            ...
            {currentData.create ? (
              ...
              <button type="button" className="btn btn--ghost" onClick={deleteStyle}>
  ...
  return (
    <div className="style-edit-props">
      <div className="style-edit-props-row">
        <select value={family} onChange={(e) => changeFamily(e.target.value)} className="form-input">
        ...
        <select value={textStyle.fontStyleName} onChange={(e) => changeFontStyle(e.target.value)} className="form-input style-edit-font-style">
          {currentFont.notFound && (
      ...
      {!textStyle.leading && (
        <div className="style-edit-props-row m-autoleading">
          ...
          <input type="number" min={0} placeholder="120" value={paragStyle.autoLeadingPercentage ? parseInt(paragStyle.autoLeadingPercentage * 100) : 120} onChange={(e) => changeAutoleading(Number(e.target.value))} className="form-input" />
      ...
      <div className="style-edit-props-row">
        <div className="style-edit-props-col">
          ...
          <select value={textStyle.autoKern || "metricsKern"} onChange={(e) => changeProp("autoKern", e.target.value)} className="form-input">
        ...
        <div className="style-edit-props-col">
          ...
          <input type="number" value={textStyle.tracking || 0} onChange={(e) => changeProp("tracking", Number(e.target.value) || 0)} className="form-input" />
        </div>
      </div>
      <div className="style-edit-props-row">
        <div className="style-edit-props-col">
          ...
          <input type="number" min={0} max={1000} value={Math.round(textStyle.verticalScale || 100)} onChange={(e) => changeProp("verticalScale", Number(e.target.value) || 100)} className="form-input" />
          <span className="style-edit-props-unit">%</span>
        </div>
        <div className="style-edit-props-col">
          ...
          <input type="number" min={0} max={1000} value={Math.round(textStyle.horizontalScale || 100)} onChange={(e) => changeProp("horizontalScale", Number(e.target.value) || 100)} className="form-input" />
          <span className="style-edit-props-unit">%</span>
        </div>
      </div>
      <div className="style-edit-props-row">
        <div className="style-edit-props-col">
          ...
          <input type="number" value={textStyle.baselineShift || 0} onChange={(e) => changeProp("baselineShift", Number(e.target.value) || 0)} className="form-input" />
          <span className="style-edit-props-unit">{unit}</span>
        </div>
        <div className="style-edit-props-col">
      ...
      {context.state.middleEast && (
        <div className="style-edit-props-row">
          <div className="style-edit-props-col">
            ...
            <input type="number" value={textStyle.diacXOffset || 0} onChange={(e) => changeProp("diacXOffset", Number(e.target.value) || 0)} className="form-input" />
            <span className="style-edit-props-unit">{unit}</span>
          </div>
          <div className="style-edit-props-col">
            ...
            <input type="number" value={textStyle.markYDistFromBaseline || 100} onChange={(e) => changeProp("markYDistFromBaseline", Number(e.target.value) || 0)} className="form-input" />
            <span className="style-edit-props-unit">{unit}</span>
          </div>
        </div>
      )}
      <div className="style-edit-props-row">
        <div className="style-edit-props-col">
          ...
          <select value={props.textProps.layerText.antiAlias || "antiAliasNone"} onChange={(e) => changeAntiAlias(e.target.value)} className="form-input">
        ...
        <div className="style-edit-props-col m-justify">
          {textStyle.syntheticBold ? (
            <button className="btn btn--icon" title={locale.editStyleBold} onClick={(e) => changeProp("syntheticBold", false, e)}>
              <BsTypeBold size={18} />
            </button>
          ) : (
            <button className="btn btn--icon btn--ghost" title={locale.editStyleBold} onClick={(e) => changeProp("syntheticBold", true, e)}>
              <BsTypeBold size={18} />
            </button>
          )}
          {textStyle.syntheticItalic ? (
            <button className="btn btn--icon" title={locale.editStyleItalic} onClick={(e) => changeProp("syntheticItalic", false, e)}>
              <BsTypeItalic size={18} />
            </button>
          ) : (
            <button className="btn btn--icon btn--ghost" title={locale.editStyleItalic} onClick={(e) => changeProp("syntheticItalic", true, e)}>
              <BsTypeItalic size={18} />
            </button>
          )}
          {textStyle.fontCaps === "allCaps" ? (
            <button className="btn btn--icon" title={locale.editStyleCapital} onClick={(e) => changeProp("fontCaps", null, e)}>
              <BsFonts size={18} />
            </button>
          ) : (
            <button className="btn btn--icon btn--ghost" title={locale.editStyleCapital} onClick={(e) => changeProp("fontCaps", "allCaps", e)}>
              <BsFonts size={18} />
            </button>
          )}
          {textStyle.fontCaps === "smallCaps" ? (
            <button className="btn btn--icon" title={locale.editStyleSmall} onClick={(e) => changeProp("fontCaps", null, e)}>
              <AiOutlineFontSize size={18} />
            </button>
          ) : (
            <button className="btn btn--icon btn--ghost" title={locale.editStyleSmall} onClick={(e) => changeProp("fontCaps", "smallCaps", e)}>
              <AiOutlineFontSize size={18} />
            </button>
          )}
        </div>
      ...
      <div className="style-edit-props-row">
        <div className="style-edit-props-col m-justify">
          {paragStyle.alignment === "left" ? (
            <button className="btn btn--icon" title={locale.editStyleAlignLeft} onClick={(e) => changeParagraph("alignment", null, e)}>
              <AiOutlineAlignLeft size={18} />
            </button>
          ) : (
            <button className="btn btn--icon btn--ghost" title={locale.editStyleAlignLeft} onClick={(e) => changeParagraph("alignment", "left", e)}>
              <AiOutlineAlignLeft size={18} />
            </button>
          )}
          {paragStyle.alignment === "center" ? (
            <button className="btn btn--icon" title={locale.editStyleAlignCenter} onClick={(e) => changeParagraph("alignment", null, e)}>
              <AiOutlineAlignCenter size={18} />
            </button>
          ) : (
            <button className="btn btn--icon btn--ghost" title={locale.editStyleAlignCenter} onClick={(e) => changeParagraph("alignment", "center", e)}>
              <AiOutlineAlignCenter size={18} />
            </button>
          )}
          {paragStyle.alignment === "right" ? (
            <button className="btn btn--icon" title={locale.editStyleAlignRight} onClick={(e) => changeParagraph("alignment", null, e)}>
              <AiOutlineAlignRight size={18} />
            </button>
          ) : (
            <button className="btn btn--icon btn--ghost" title={locale.editStyleAlignRight} onClick={(e) => changeParagraph("alignment", "right", e)}>
              <AiOutlineAlignRight size={18} />
            </button>
          )}
          {paragStyle.hyphenate ? (
            <button className="btn btn--icon" title={locale.editStyleHyphen} onClick={(e) => changeParagraph("hyphenate", false, e)}>
              <FiMinus size={18} />
            </button>
          ) : (
            <button className="btn btn--icon btn--ghost" title={locale.editStyleHyphen} onClick={(e) => changeParagraph("hyphenate", true, e)}>
              <FiMinus size={18} />
            </button>
          )}
          {paragStyle.hangingRoman ? (
            <button className="btn btn--icon" title={locale.editStyleHanging} onClick={(e) => changeParagraph("hangingRoman", false, e)}>
              <GrBlockQuote size={18} />
            </button>
          ) : (
            <button className="btn btn--icon btn--ghost" title={locale.editStyleHanging} onClick={(e) => changeParagraph("hangingRoman", true, e)}>
              <GrBlockQuote size={18} />
            </button>
          )}
        </div>
        <div className="style-edit-props-col m-justify">
          {textStyle.baseline === "superScript" ? (
            <button className="btn btn--icon" title={locale.editStyleSuper} onClick={(e) => changeProp("baseline", "normal", e)}>
              <GrSuperscript size={18} />
            </button>
          ) : (
            <button className="btn btn--icon btn--ghost" title={locale.editStyleSuper} onClick={(e) => changeProp("baseline", "superScript", e)}>
              <GrSuperscript size={18} />
            </button>
          )}
          {textStyle.baseline === "subScript" ? (
            <button className="btn btn--icon" title={locale.editStyleSub} onClick={(e) => changeProp("baseline", "normal", e)}>
              <GrSubscript size={18} />
            </button>
          ) : (
            <button className="btn btn--icon btn--ghost" title={locale.editStyleSub} onClick={(e) => changeProp("baseline", "subScript", e)}>
              <GrSubscript size={18} />
            </button>
          )}
          {textStyle.underline === "underlineOnLeftInVertical" ? (
            <button className="btn btn--icon" title={locale.editStyleUnderline} onClick={(e) => changeProp("underline", "underlineOff", e)}>
              <BsTypeUnderline size={18} />
            </button>
          ) : (
            <button className="btn btn--icon btn--ghost" title={locale.editStyleUnderline} onClick={(e) => changeProp("underline", "underlineOnLeftInVertical", e)}>
              <BsTypeUnderline size={18} />
            </button>
          )}
          {textStyle.strikethrough === "xHeightStrikethroughOn" ? (
            <button className="btn btn--icon" title={locale.editStyleStrike} onClick={(e) => changeProp("strikethrough", "strikethroughOff", e)}>
              <BsTypeStrikethrough size={18} />
            </button>
          ) : (
            <button className="btn btn--icon btn--ghost" title={locale.editStyleStrike} onClick={(e) => changeProp("strikethrough", "xHeightStrikethroughOn", e)}>
              <BsTypeStrikethrough size={18} />
            </button>
          )}
        </div>
